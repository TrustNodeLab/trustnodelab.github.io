...
const SUBTITLE_BY_LANG: Partial<Record<LanguageCode, string>> = {
  ...
  tr: "Telefonunuzun yerel RAM'inde tamamen çalışan, konuşabilen akıllı bir asistan"
};
  ...
  tr: [
    {
      ...
      desc: "Ana rubert-tiny2 modeli üzerine ince ayarlanmış, yüksek oranda optimize edilmiş bir eklenti. Modele yalnızca ~200 KB ağırlık ekleyerek 15-20 özel güvenlik niyetini çözer."
    },
    {
      title: "%100 Çevrimdışı Çalışma",
      desc: "Pahalı ve yavaş harici LLM API çağrısı yoktur. Tamamen çevrimdışı yanıt şablonları ve konuşma işleme algoritmaları, gecikmeyi mikrosaniyeler seviyesinde tutar."
    },
    {
      title: "Gelişmiş Eğitim Veri Kümeleri",
      desc: "Google Colab bulutunda Llama 3.1 ve Qwen2.5 modelleri kullanılarak sentezlenen, sosyal mühendislik senaryolarına özel sentetik diyaloglarla eğitildi."
    }
  ]
};
