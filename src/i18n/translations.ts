...
const ru: Translations = {
  ...
  how: {
    ...
    layers: [
      ...
      {
        name: "Поведенческий анализ — по заявке на патент",
        tech: "Context-Aware State Machine · в разработке",
        desc: "Архитектура по заявке на патент: будет следить за динамикой взаимодействия — скоростью ввода, частотой переключений между экранами банковских приложений во время звонка, аномальными задержками и паттернами удержания внимания."
      },
      {
        name: "Консенсус PHANTOM — по заявке на патент",
        tech: "Consensus Voting Engine · в разработке",
        desc: "Архитектура по заявке на патент: будет принимать окончательное взвешенное решение на основе выходов всех уровней, блокировать интерфейс при угрозе и отправлять пуш доверенному контакту."
      }
    ],
    usp: [
      {
      ...
      {
        title: "Система маяков (Beacon System) — по заявке на патент",
        desc: "Roadmap: при обнаружении критической фрод-активности система маяков будет оповещать ваших близких и доверенных контактов через VK."
      },
      {
    ...
    sevenLayers: [
      ...
      },
      {
        ...
        tech: "ONNX Runtime / 28.4 MB Local Model",
        desc: "Локальный анализ текста звонков и сообщений. Нейросеть rubert-tiny2 обрабатывает данные строго на устройстве, отдельно от алгоритмов консенсуса."
      },
      {
        name: "Сценарии социнженерии (Social Eng. Layer) — по заявке на патент",
        tech: "DeGenome (18 примитивов) · в разработке",
        desc: "Архитектура по заявке на патент: будет выявлять таксономию манипуляций по 18 примитивам DeGenome — искусственную спешку, запугивание, требования конфиденциальности и эмоциональный прессинг."
      },
      {
        name: "Поведенческий анализ (Behavioral Layer) — по заявке на патент",
        tech: "Context-Aware State Machine · в разработке",
        desc: "Архитектура по заявке на патент: будет следить за динамикой взаимодействия в реальном времени — скоростью набора текста, задержками ответов, частотой переходов между экранами мобильного банка."
      },
      {
        name: "Репутационный контур (Reputation Layer) — по заявке на патент",
        tech: "PCD Identity Profiles · в разработке",
        desc: "Архитектура по заявке на патент: будет сверять манеру общения звонящего с профилями поведенческой идентичности организаций — кто, когда и в каком тоне действительно имеет право звонить от лица банка или ведомства."
      },
      {
        name: "Консенсус и принятие решений (Consensus Agent) — по заявке на патент",
        tech: "Consensus Voting Engine · в разработке",
        desc: "Архитектура по заявке на патент: алгоритм консенсуса JudgeAgent будет независимо взвешивать оценки со всех уровней системы, при угрозе блокировать действия и оповещать доверенные контакты."
      },
      {
        name: "Иммунная память (Immune Memory) — по заявке на патент",
        tech: "Adaptive Incident Shield · в разработке",
        desc: "Архитектура по заявке на патент: долгосрочная изолированная память об атаках, которая будет локально адаптировать профили защиты на основе предотвращённых инцидентов."
      }
    ],
    btnSimplified: "Упрощенная структура",
    btnAdvanced: "Архитектура PHANTOM 2.0 (по заявке на патент, roadmap, 7 слоёв)",
    pipelineHeader: "Архитектура по заявке на патент PHANTOM 2.0 — план развития"
  },
  trust: {
    badge: "Научная валидация & Признание",
    title: "Научное",
    titleHighlight: "признание",
  ...
  footer: {
    ...
    legalEntity: "Разработчик: Питолин Михаил Евгеньевич, г. Челябинск, РФ",
    legalEntityContact: "Почта: mikhailpitolin@gmail.com | Telegram: @TrustNode_team"
  },
  cookie: {
  ...
  legal: {
    ...
    privacy: {
      s1: {
        ...
        body: "Настоящая Политика в отношении обработки персональных данных составлена в соответствии с требованиями Федерального закона РФ № 152-ФЗ «О персональных данных» от 27.07.2006 года. Она определяет порядок обработки персональных данных пользователей и меры по обеспечению безопасности этих данных, принимаемые командой проекта TrustNode Protocol (далее — Оператор)."
      },
      s2: {
        heading: "[ ПРИНЦИП КУПОЛА: 100% БЕЗОПАСНО ДЛЯ ПРИВАТНОСТИ ]",
        noticeLabel: "Критически важное уведомление:",
        noticeBody: "Разделение сущностей: 1) Мобильное приложение TrustNode работает на 100% локально на вашем устройстве; все защитные алгоритмы ИИ выполняются на процессоре смартфона без отправки вашего трафика или файлов на наши сервера. 2) Сайт проекта (форма списка ожидания) собирает исключительно введённый вами контактный хендл (E-mail или Telegram) для отправки уведомлений о раннем доступе. Эти данные хранятся на сервере, и вы в любой момент можете запросить их полное удаление."
      },
      s3: {
        heading: "[ ОБРАБАТЫВАЕМЫЕ ДАННЫЕ НА САЙТЕ ]",
        intro: "При использовании данного сайта (включая заполнение формы списка ожидания раннего доступа) обрабатываются следующие категории данных:",
        items: [
          "Контактные данные (Telegram @username или E-mail) — собираются через форму для отправки уведомлений о раннем доступе;",
          "Параметры окружения (Мобильная платформа: Android/iOS, Микроархитектура ЦП, желаемый уровень защиты) — собираются для оптимизации сборки ПО;",
          "Дата и время отправки заявки (createdAt) и сгенерированный уникальный ID билета;",
          "Файлы cookie (необходимы для кэширования настроек графики и режима энергосбережения);",
          "Анонимные технические данные (IP-адрес, тип браузера, технические заголовки)."
        ]
      },
      s3a: {
        heading: "[ СОГЛАСИЕ НА ОБРАБОТКУ ПЕРСОНАЛЬНЫХ ДАННЫХ ]",
        body: "Заполняя форму списка ожидания (Waitlist) на Сайте, Пользователь предоставляет Оператору свои контактные данные (Telegram @username или адрес электронной почты). Отправляя форму, Пользователь подтверждает, что ознакомился с настоящей Политикой конфиденциальности и даёт добровольное, информированное и осознанное согласие на обработку своих персональных данных в целях связи по вопросам тестирования и раннего доступа к ПО TrustNode. Согласие включает сбор, запись, систематизацию, накопление, хранение, уточнение (обновление, изменение), извлечение, использование, передачу (в объёме, необходимом для цели обработки), обезличивание, блокирование, удаление и уничтожение персональных данных. Согласие действует до момента его отзыва Пользователем. Пользователь вправе отозвать согласие, направив письменное уведомление на адрес электронной почты Оператора."
      },
      s4: {
        heading: "[ ЦЕЛЬ, СРОК ХРАНЕНИЯ И УДАЛЕНИЕ ДАННЫХ ]",
        body: "Данные из формы списка ожидания собираются исключительно для связи по вопросам бета-тестирования TrustNode. Они хранятся в защищённой базе данных сервера до окончания этапа тестирования. Пользователь имеет полное право в любой момент запросить удаление своих данных: для этого достаточно отправить запрос на адрес электронной почты mikhailpitolin@gmail.com или написать напрямую в Telegram-чат @TrustNode_team с указанием своего контакта. Данные будут безвозвратно удалены в течение 24 часов."
      },
      s4a: {
        heading: "[ ФАЙЛЫ COOKIE ]",
        body: "Сайт использует файлы cookie и аналогичные технологии для обеспечения работоспособности сайта, сохранения настроек графики и эко-режима. Cookie — это небольшие текстовые файлы, размещаемые на устройстве Пользователя. Пользователь может отключить использование cookie в настройках своего браузера. Продолжая использование Сайта, Пользователь соглашается на использование cookie в соответствии с настоящей Политикой."
      },
      s5: {
    ...
    terms: {
      ...
      s2: {
        heading: "[ 2. СТАТУС РАЗРАБОТКИ ПРОГРАММНОГО ОБЕСПЕЧЕНИЯ ]",
        noticeLabel: "Важное уведомление:",
        noticeBody: "TrustNode находится на стадии архитектурной разработки и прототипирования. Некоторые функции, описанные на сайте, являются плановыми (Roadmap) и могут быть изменены или не реализованы в финальной версии продукта. Информация о характеристиках продукта предоставлена для ознакомления и не является гарантией их наличия в коммерческой версии."
      },
      s3: {
      ...
      s4: {
        ...
        body: "Ранний платный доступ предоставляется исключительно на условиях индивидуального пользовательского соглашения (EULA), подписываемого или принимаемого в электронном виде при установке ПО. Запрещается использование ПО TrustNode для нелегального перехвата трафика третьих лиц или иных противоправных действий в сетях электросвязи РФ."
      },
      s4a: {
        heading: "[ 4a. ПОРЯДОК ВОЗВРАТА ДЕНЕЖНЫХ СРЕДСТВ ]",
        body: "В случае приобретения платной лицензии Пользователь вправе отказаться от услуги и потребовать возврат денежных средств в течение 14 (четырнадцати) календарных дней с момента оплаты при условии, что лицензионный ключ не был активирован. Для возврата необходимо направить заявление на адрес электронной почты mikhailpitolin@gmail.com. Возврат осуществляется в течение 10 (десяти) рабочих дней с момента получения заявления. После активации лицензионного ключа возврат денежных средств не производится, поскольку услуга считается оказанной в полном объёме (активация доступа к программному обеспечению)."
      },
      s5: {
        heading: "[ 5. ИЗМЕНЕНИЕ СОГЛАШЕНИЯ ]",
        body: "Администрация ресурса оставляет за собой право изменять условия настоящего Соглашения. Пользователи уведомляются об изменениях путём публикации новой версии на этой странице. Продолжение использования Сайта после внесения изменений означает согласие Пользователя с новой редакцией Соглашения."
      }
    }
  },
  pageNames: {
  ...
  realDev: {
    ...
    onnxDetails: {
      ...
      filename: "rubert_fraud_merged_int8.onnx",
      size: "28.4 MB",
      format: "ONNX Runtime (INT8 quantized)",
      desc: "В корне проекта интегрирована реальная бинарная квантованная языковая модель rubert-tiny2 в формате INT8. Модель оптимизирована для сверхбыстрого инференса на CPU мобильных устройств и полностью работает в локальном RAM.",
      badge: "ЛОКАЛЬНЫЙ ИНФЕРЕНС"
    }
  },
  origin: {
    title: "История проекта",
    subtitle: "От дипломных исследований студента-кибербезопасника до заявок на патент ФИПС и федерального признания",
    ...
    timeline: [
      ...
      },
      {
        ...
        title: "Приглашение на федеральный финал",
        desc: "По результатам победы на региональном этапе проект приглашён на федеральный суперфинал научно-исследовательских работ в Москве, который состоится в сентябре 2026 года — предстоит демонстрация эффективности мобильного купола защиты."
      },
      {
  ...
  security: {
    ...
    complianceText: "Юридический статус программного обеспечения TrustNode в отношении применимых нормативных требований в настоящее время уточняется.",
    features: [
      {
  ...
  kira: {
    ...
    subtitle: "Интеллектуальный речевой контур в разработке — по плану будет работать прямо в оперативной памяти телефона",
    badge: "ПРОГРАММНЫЙ ПЛАН: KIRA",
    features: [
      {
        title: "Локальный Интент-Классификатор — согласно плану",
        desc: "Roadmap: дообученная надстройка над основной rubert-tiny2 будет распознавать 15-20 специализированных интентов безопасности, добавляя к модели всего ~200 КБ весов."
      },
      {
        title: "Работа на 100% Офлайн — согласно плану",
        desc: "Roadmap: без обращений к облачным LLM — вся семантическая структура и шаблоны ответов будут упакованы в приложение, работая без сети в режиме сверхнизкой задержки."
      },
      {
        title: "Синтетический Датасет Коллаборации",
        desc: "Обучающие диалоги мошеннических схем уже генерируются в облаке Google Colab с помощью Llama 3.1 и Qwen2.5 — эта часть работы ведётся уже сейчас."
      }
    ]
  },
  explore: {
  ...
  earlyAccessPage: {
    ...
    subtitle: "Выберите один из пакетов раннего доступа и станьте частью сообщества безопасности нового поколения",
    badge: "РАННИЙ ДОСТУП // ПАКЕТЫ ПРЕДЗАКАЗА",
    pkgPriorityTitle: "Приоритетный доступ (Priority)",
    pkgPriorityDesc: "Доступ к TrustNode v1, v3, Kira — раньше всех + приоритетное участие в закрытом бета-тестировании будущих модулей.",
    pkgStandardTitle: "Стандартный (Standard)",
    pkgStandardDesc: "Лицензия на TrustNode v1 и v3 после официального релиза.",
    pkgBasicTitle: "Базовый (Basic)",
    pkgBasicDesc: "Доступ к базовой защите TrustNode v1.",
    pricePriority: "599₽",
    priceStandard: "299₽",
    priceBasic: "Бесплатно",
    ...
    ticketReadyInstruction: "Скопируйте ID билета ниже и перейдите к оплате для завершения регистрации.",
    btnGoToPayment: "Перейти к оплате",
    paymentDisclaimer: "Оплата производится через защищенный внешний шлюз. Ваши данные находятся под защитой.",
...
const en: Translations = {
  ...
  how: {
    ...
    layers: [
      ...
      {
        name: "Behavioral analysis — per patent app.",
        tech: "Context-Aware State Machine · in development",
        desc: "Roadmap: will track interaction dynamics — typing speed, how often the screen switches to banking apps during a call, anomalous delays, and attention-holding patterns."
      },
      {
        name: "PHANTOM consensus — per patent app.",
        tech: "Consensus Voting Engine · in development",
        desc: "Roadmap: will make the final weighted decision based on the outputs of all layers. If an attack is suspected, it will lock the interface, warn the user, and send an instant push to a trusted contact."
      }
    ],
    usp: [
      {
      ...
      {
        title: "Beacon Alerting System — per patent app.",
        desc: "Roadmap: upon detecting critical fraud activity, our Beacon System will notify your loved ones and trusted contacts via VK."
      },
      {
    ...
    sevenLayers: [
      ...
      {
        name: "Social Engineering (Social Eng. Layer) — per patent app.",
        tech: "DeGenome (18 Primitives) · in development",
        desc: "Roadmap: will identify manipulation tactics using the DeGenome taxonomy of 18 primitives — artificial urgency, pressure speech, fear triggers, and isolation requests."
      },
      {
        name: "Behavioral Auditing (Behavioral Layer) — per patent app.",
        tech: "Context-Aware State Machine · in development",
        desc: "Roadmap: will continuously track live user interactions — typing cadence, cognitive processing delays, and switching frequencies between financial and calling apps during a live call."
      },
      {
        name: "Reputation Verification (Reputation Layer) — per patent app.",
        tech: "PCD Identity Profiles · in development",
        desc: "Roadmap: will cross-check caller traits with corporate identity profiles (PCD), identifying when speech patterns and caller actions mismatch official protocols."
      },
      {
        name: "Consensus Resolution (Consensus Agent) — per patent app.",
        tech: "Consensus Voting Engine · in development",
        desc: "Roadmap: a dedicated consensus voting algorithm (JudgeAgent) will aggregate risk markers from all levels to lock executions and send alerts."
      },
      {
        name: "Immune Memory — per patent app.",
        tech: "Adaptive Incident Shield · in development",
        desc: "Roadmap: a localized secure attack repository that will enable on-device fine-tuning of security filters based on recently mitigated threats."
      }
    ],
    btnSimplified: "Simplified View",
    btnAdvanced: "PHANTOM 2.0 Patent-Pending Architecture (Roadmap, 7 Layers)",
    pipelineHeader: "Patent-Pending PHANTOM 2.0 Architecture — Development Roadmap"
  },
  trust: {
  ...
  footer: {
    ...
    legalEntity: "Developer: Pitolin Mikhail Evgenyevich, Chelyabinsk, Russia",
    legalEntityContact: "Email: mikhailpitolin@gmail.com | Telegram: @TrustNode_team"
  },
  cookie: {
  ...
  legal: {
    ...
    privacy: {
      s1: {
        ...
        body: "This Privacy Policy is drafted in accordance with Russian Federal Law No. 152-FZ \"On Personal Data\" of 27 July 2006. It defines how the TrustNode Protocol project team (the \"Operator\") processes user personal data and the safeguards applied to it."
      },
      s2: {
        heading: "[ THE DOME PRINCIPLE: 100% SAFE FOR YOUR PRIVACY ]",
        noticeLabel: "Critical notice:",
        noticeBody: "Entity separation: 1) The TrustNode mobile app runs 100% locally on your device; all protective AI mechanisms execute on your smartphone's CPU without sending your traffic or files to our servers. 2) This website (waitlist form) collects only the contact handle (E-mail or Telegram) you submit to notify you about early access. This data is stored securely on our server, and you can request its complete deletion at any time."
      },
      s3: {
        heading: "[ DATA PROCESSED BY THE WEBSITE ]",
        intro: "When using this website (including submitting the early access waitlist form), the following categories of data are processed:",
        items: [
          "Contact handle (Telegram @username or E-mail) — collected via the form to send early access notifications;",
          "Device environment (Mobile OS: Android/iOS, CPU microarchitecture, and desired level of protection) — collected to optimize the software build;",
          "Registration timestamp (createdAt) and the generated unique license ticket ID;",
          "Cookies (needed to cache performance and eco-mode settings);",
          "Anonymized technical data (IP address, browser type, technical headers)."
        ]
      },
      s3a: {
        heading: "[ CONSENT TO PERSONAL DATA PROCESSING ]",
        body: "By submitting the waitlist form on this Website, the User provides the Operator with their contact details (Telegram @username or email address). By submitting the form, the User confirms that they have read this Privacy Policy and gives their voluntary, informed, and explicit consent to the processing of their personal data for the purpose of communication regarding testing and early access to TrustNode software. Processing includes collection, recording, systematization, accumulation, storage, clarification (updating, modification), retrieval, use, transfer (to the extent necessary for processing purposes), anonymization, blocking, deletion, and destruction of personal data. Consent is valid until withdrawn by the User. The User may withdraw consent by sending a written notice to the Operator's email address."
      },
      s4: {
        heading: "[ PURPOSE, RETENTION, AND DATA DELETION ]",
        body: "Waitlist form data is collected strictly for communication regarding TrustNode beta testing. It is stored securely on our server until the end of the beta testing phase. Users have the right to request the complete deletion of their data at any time: simply send an email request to mikhailpitolin@gmail.com or write to our Telegram support chat @TrustNode_team. Your data will be permanently erased from our database within 24 hours."
      },
      s4a: {
        heading: "[ COOKIES ]",
        body: "This Website uses cookies and similar technologies to ensure its functionality and to store graphics and eco-mode settings. Cookies are small text files placed on the User's device. The User may disable cookies in their browser settings. By continuing to use the Website, the User consents to the use of cookies in accordance with this Policy."
      },
      s5: {
    ...
    terms: {
      ...
      s2: {
        heading: "[ 2. SOFTWARE DEVELOPMENT STATUS ]",
        noticeLabel: "Important notice:",
        noticeBody: "TrustNode is currently in architectural design and prototyping stage. Some features described on this website are planned (Roadmap) and may be changed or may not be implemented in the final product. Product specifications are provided for informational purposes only and do not constitute a guarantee of their availability in the commercial version."
      },
      s3: {
      ...
      s4: {
        ...
        body: "Early paid access is granted solely under an individual End-User License Agreement (EULA), signed or accepted electronically at installation. Using TrustNode software to unlawfully intercept third-party traffic or for any other unlawful activity on Russian telecom networks is prohibited."
      },
      s4a: {
        heading: "[ 4a. REFUND POLICY ]",
        body: "If a paid license is purchased, the User has the right to cancel and request a full refund within 14 (fourteen) calendar days from the payment date, provided the license key has not been activated. To request a refund, please send an application to mikhailpitolin@gmail.com. The refund will be processed within 10 (ten) business days from receipt of the request. Once the license key has been activated, no refund will be issued as the service is considered fully rendered (activation of access to the software)."
      },
      s5: {
        heading: "[ 5. CHANGES TO THIS AGREEMENT ]",
        body: "The site administration reserves the right to modify the terms of this Agreement. Users will be notified of changes by posting the new version on this page. Continued use of the Website after modifications constitutes acceptance of the updated Agreement."
      }
    }
  },
  pageNames: {
  ...
  origin: {
    ...
    timeline: [
      ...
      },
      {
        ...
        desc: "Following the regional triumph, the project has been invited to the federal scientific research superfinal in Moscow, taking place in September 2026, where it will demonstrate its real-time defense capabilities."
      },
      {
  ...
  security: {
    ...
    complianceText: "The legal status of TrustNode software under applicable regulatory requirements is currently under review.",
    features: [
      {
  ...
  kira: {
    ...
    subtitle: "An intelligent, speech-capable companion in development — planned to run fully within your local RAM",
    badge: "PROJECT TIMELINE: KIRA",
    features: [
      {
        title: "Local Intent Classifier — per roadmap",
        desc: "Roadmap: a fine-tuned add-on on top of the main rubert-tiny2 model will resolve 15-20 specific security intents, introducing a mere 200 KB memory footprint."
      },
      {
        title: "100% Offline Execution — per roadmap",
        desc: "Roadmap: no external LLM API calls — fully offline response templates and speech processing algorithms will keep execution latency down to microseconds."
      },
      {
        title: "Advanced Training Datasets",
        desc: "Synthetic dialogues of social-engineering schemes are already being generated in Google Colab using Llama 3.1 and Qwen2.5 — this part of the work is underway now."
      }
    ]
  },
  explore: {
    ...
    card1Desc: "Technical breakdown of the 7-layer PHANTOM 2.0 security dome (patent-pending architecture, part roadmap) and the intelligent voice assistant KIRA, planned to run fully on-device.",
  ...
  earlyAccessPage: {
    ...
    subtitle: "Choose one of our early access packages and become part of the next-generation security community",
    badge: "EARLY ACCESS // PRE-ORDER PACKAGES",
    pkgPriorityTitle: "Priority Access",
    pkgPriorityDesc: "Access to TrustNode v1, v3, Kira — earliest of all + priority participation in closed beta testing of future modules.",
    pkgStandardTitle: "Standard Access",
    pkgStandardDesc: "License for TrustNode v1 and v3 after the official release.",
    pkgBasicTitle: "Basic Access",
    pkgBasicDesc: "Access to basic TrustNode v1 protection.",
    pricePriority: "599₽",
    priceStandard: "299₽",
    priceBasic: "Free",
    ...
    ticketReadyInstruction: "Copy the ticket ID below and proceed to payment to complete registration.",
    btnGoToPayment: "Proceed to Payment",
    paymentDisclaimer: "Payment is processed via a secure external gateway. Your data is protected.",
...
const es: Translations = {
  ...
  how: {
    ...
    layers: [
      ...
      {
        name: "Análisis de comportamiento — según solicitud de patente",
        tech: "Máquina de estados sensible al contexto · en desarrollo",
        desc: "Roadmap: monitoreará la dinámica de la interacción — velocidad de escritura, frecuencia de cambio a apps bancarias durante una llamada, retrasos anómalos y patrones de retención de atención."
      },
      {
        name: "Consenso PHANTOM — según solicitud de patente",
        tech: "Motor de votación por consenso · en desarrollo",
        desc: "Roadmap: tomará la decisión final ponderada a partir de las salidas de todas las capas. Ante una posible amenaza, bloqueará la interfaz, avisará al usuario y enviará una notificación a un contacto de confianza."
      }
    ],
    usp: [
      {
    ...
    sevenLayers: [
      ...
      {
        name: "Ingeniería social (Social Eng. Layer) — según solicitud de patente",
        tech: "DeGenome (18 Primitives) · en desarrollo",
        desc: "Roadmap: identificará tácticas de manipulación mediante la taxonomía DeGenome de 18 primitivas — urgencia artificial, discursos de presión, desencadenantes de miedo y solicitudes de aislamiento."
      },
      {
        name: "Auditoría de comportamiento (Behavioral Layer) — según solicitud de patente",
        tech: "Context-Aware State Machine · en desarrollo",
        desc: "Roadmap: realizará un seguimiento continuo de las interacciones del usuario — cadencia de escritura, retrasos cognitivos y frecuencias de cambio entre apps financieras y de llamadas."
      },
      {
        name: "Verificación de reputación (Reputation Layer) — según solicitud de patente",
        tech: "PCD Identity Profiles · en desarrollo",
        desc: "Roadmap: verificará las características del llamador con perfiles de identidad corporativa (PCD), identificando cuando el habla y las acciones no coinciden con los protocolos oficiales."
      },
      {
        name: "Resolución de consenso (Consensus Agent) — según solicitud de patente",
        tech: "Consensus Voting Engine · en desarrollo",
        desc: "Roadmap: un motor de consenso JudgeAgent agregará marcadores de riesgo de todos los niveles para bloquear la ejecución, alertar al usuario y activar contactos de confianza."
      },
      {
        name: "Memoria inmune (Immune Memory) — según solicitud de patente",
        tech: "Adaptive Incident Shield · en desarrollo",
        desc: "Roadmap: repositorio local seguro de ataques que permitirá el ajuste fino en el dispositivo según amenazas mitigadas recientemente."
      }
    ],
    btnSimplified: "Vista simplificada",
    btnAdvanced: "Arquitectura PHANTOM 2.0 (según solicitud de patente, roadmap, 7 capas)",
    pipelineHeader: "Arquitectura PHANTOM 2.0 según solicitud de patente — hoja de ruta"
  },
  trust: {
  ...
  legal: {
    ...
    privacy: {
      s1: {
        ...
        body: "Esta Política de Privacidad se redacta conforme a la Ley Federal de Rusia N.º 152-FZ «Sobre Datos Personales» del 27 de julio de 2006. Define cómo el equipo del proyecto TrustNode Protocol (el «Operador») procesa los datos personales de los usuarios y las medidas de seguridad aplicadas."
      },
      s2: {
        heading: "[ EL PRINCIPIO DE LA CÚPULA: 100% SEGURO PARA TU PRIVACIDAD ]",
        noticeLabel: "Aviso crítico:",
        noticeBody: "Separación de entidades: 1) La aplicación móvil de TrustNode funciona 100% localmente en tu dispositivo; todos los mecanismos de IA se ejecutan en la CPU de tu teléfono sin enviar tu tráfico o archivos a nuestros servidores. 2) Este sitio web (formulario de lista de espera) recopila únicamente el contacto (E-mail o Telegram) que envíes para notificarte sobre el acceso anticipado. Estos datos se almacenan en el servidor y puedes solicitar su eliminación completa en cualquier momento."
      },
      s3: {
      ...
      s4: {
        heading: "[ TRANSFERENCIA DE DATOS Y CONTACTO CON EL OPERADOR ]",
        body: "Hemos dejado atrás las bases de datos de suscripción estándar en el sitio. El contacto con el Operador para obtener acceso anticipado ocurre por iniciativa del usuario, exclusivamente a través de mensajería y redes sociales externas seguras (Telegram, VKontakte, TikTok). Al compartir sus datos de contacto en un mensaje privado, el usuario da su consentimiento voluntario para comunicarse sobre licencias."
      },
      s5: {
    ...
    terms: {
      ...
      s2: {
        ...
        noticeBody: "El estado legal del software TrustNode respecto a los requisitos regulatorios aplicables esta siendo revisado actualmente. Se publicara informacion detallada tras la consulta con un asesor legal calificado."
      },
      s3: {
      ...
      s4: {
        ...
        body: "El acceso anticipado de pago se concede exclusivamente bajo un Acuerdo de Licencia de Usuario Final (EULA) individual, firmado o aceptado electrónicamente durante la instalación. Está prohibido usar el software TrustNode para interceptar ilegalmente el tráfico de terceros o realizar cualquier otra actividad ilícita en redes de telecomunicaciones de Rusia."
      },
      s5: {
        heading: "[ 5. MODIFICACIONES DEL ACUERDO ]",
        body: "La administración del sitio informará a los usuarios sobre los cambios publicando la nueva versión en esta página. La versión vigente del Acuerdo siempre está disponible en esta página."
      }
    }
  },
  pageNames: {
  ...
  security: {
    ...
    complianceText: "El estado legal del software TrustNode respecto a los requisitos regulatorios aplicables esta siendo revisado actualmente.",
    features: [
      {
  ...
  kira: {
    ...
    subtitle: "Un bucle de voz inteligente en desarrollo — planeado para ejecutarse directamente en la memoria RAM de su teléfono",
    badge: "CRONOGRAMA DEL PROYECTO: KIRA",
    features: [
      {
        title: "Clasificador de Intenciones Local — según roadmap",
        desc: "Roadmap: una extensión entrenada sobre la red rubert-tiny2 reconocerá entre 15 y 20 intenciones de seguridad especializadas, añadiendo solo ~200 KB de peso al modelo."
      },
      {
        title: "Ejecución 100% Fuera de Línea — según roadmap",
        desc: "Roadmap: sin conexiones a LLM en la nube — toda la estructura semántica y las plantillas de respuestas funcionarán sin conexión con latencia ultra baja."
      },
      {
        title: "Conjunto de Datos Sintéticos",
        desc: "Los diálogos sintéticos de esquemas de fraude ya se generan en Google Colab mediante Llama 3.1 y Qwen2.5 — esta parte del trabajo está en curso."
      }
    ]
  },
  explore: {
    ...
    card1Desc: "Desglose técnico del domo de seguridad de 7 capas PHANTOM 2.0 (arquitectura patentada, parte en roadmap) y el asistente de voz inteligente KIRA, planeado para ejecutarse en el dispositivo.",
    card1Btn: "Ver Tecnología →",
    card2Title: "Eficacia Demostrada",
    card2Badge: "VALIDACIÓN Y PATENTES",
    card2Desc: "Solicitud de patente oficial, primer puesto en concurso regional de investigación, final nacional en Moscú e historia del proyecto.",
  ...
  earlyAccessPage: {
    ...
    subtitle: "Elija uno de nuestros paquetes de acceso anticipado y forme parte de la comunidad de seguridad de próxima generación",
    badge: "ACCESO ANTICIPADO // PAQUETES DE RESERVA",
    pkgPriorityTitle: "Acceso Prioritario",
    pkgPriorityDesc: "Acceso a TrustNode v1, v3, Kira — el más temprano de todos + participación prioritaria en pruebas beta cerradas de futuros módulos.",
    pkgStandardTitle: "Acceso Estándar",
    pkgStandardDesc: "Licencia para TrustNode v1 y v3 después del lanzamiento oficial.",
    pkgBasicTitle: "Acceso Básico",
    pkgBasicDesc: "Acceso a la protección básica de TrustNode v1.",
    pricePriority: "599₽",
    priceStandard: "299₽",
    priceBasic: "Gratis",
    ...
    ticketReadyInstruction: "Copie el ID del boleto a continuación y proceda al pago para completar el registro.",
    btnGoToPayment: "Proceder al Pago",
    paymentDisclaimer: "El pago se procesa a través de una pasarela externa segura. Sus datos están protegidos.",
...
const zh: Translations = {
  ...
  how: {
    ...
    layers: [
      ...
      },
      {
        name: "行为分析 — 专利申请路线图",
        tech: "情境感知状态机 · 开发中",
        desc: "路线图：未来将追踪交互动态——打字速度、通话中切换到银行应用的频率、异常延迟以及注意力控制模式。"
      },
      {
        name: "PHANTOM 共识引擎 — 专利申请路线图",
        tech: "共识投票引擎 · 开发中",
        desc: "路线图：未来将根据各层级的输出结果做出最终加权判断，一旦怀疑存在攻击即锁定界面、警示用户并通知可信联系人。"
      }
    ],
    usp: [
      {
    ...
    sevenLayers: [
      ...
      {
        name: "社会工程学分析 (Social Eng. Layer) — 专利申请路线图",
        tech: "DeGenome (18基元) · 开发中",
        desc: "路线图：未来将使用包含18个基元的 DeGenome 分类法识别操纵策略——人为制造的紧迫感、施压言论、恐惧触发因素和孤立请求。"
      },
      {
        name: "行为审计 (Behavioral Layer) — 专利申请路线图",
        tech: "Context-Aware State Machine · 开发中",
        desc: "路线图：未来将持续跟踪用户的实时交互——打字节奏、认知处理延迟以及金融应用和通话应用之间的切换频率。"
      },
      {
        name: "信誉验证 (Reputation Layer) — 专利申请路线图",
        tech: "PCD Identity Profiles · 开发中",
        desc: "路线图：未来将把呼叫者特征与企业身份配置文件 (PCD) 交叉比对，识别言语模式与官方协议不匹配的情况。"
      },
      {
        name: "共识决策 (Consensus Agent) — 专利申请路线图",
        tech: "Consensus Voting Engine · 开发中",
        desc: "路线图：JudgeAgent 共识引擎未来将汇总各层级的风险标记，达到威胁阈值时锁定执行、警告用户并通知受信联系人。"
      },
      {
        name: "免疫记忆 (Immune Memory) — 专利申请路线图",
        tech: "Adaptive Incident Shield · 开发中",
        desc: "路线图：未来将建立本地安全攻击存储库，基于最近缓解的威胁进行设备端安全微调。"
      }
    ],
    btnSimplified: "简化视图",
    btnAdvanced: "PHANTOM 2.0 专利申请架构（路线图，7层）",
    pipelineHeader: "PHANTOM 2.0 专利申请架构 — 发展路线图"
  },
  trust: {
    badge: "科学验证与认可",
    title: "科学",
  ...
  legal: {
    ...
    privacy: {
      s1: {
        heading: "[ 总则 ]",
        body: "本隐私政策依据2006年7月27日颁布的俄罗斯联邦第152-FZ号法律《个人数据法》制定，规定了 TrustNode Protocol 项目团队（以下简称“运营方”）处理用户个人数据的方式及相应的数据安全保障措施。"
      },
      s2: {
        heading: "[ 穹顶原则：100% 保护你的隐私 ]",
        noticeLabel: "重要提示：",
        noticeBody: "实体区分：1) TrustNode 移动应用完全在您的设备本地 100% 运行，所有防护性 AI 机制均在智能手机 CPU 上执行，不会将您的流量或文件发送到我们的服务器。2) 本网站（等待队列表单）仅收集您提交的联系方式（电子邮箱或 Telegram），用于通知您获取早期访问权限。这些数据安全地存储在我们的服务器上，您可以随时请求将其完全删除。"
      },
      s3: {
        heading: "[ 网站处理的数据 ]",
      ...
      s4: {
        heading: "[ 数据传输与联系运营方 ]",
        body: "我们没有在网站上使用标准的订阅数据库。用户如需获取抢先体验资格，需自行主动通过第三方安全即时通讯工具及社交平台（Telegram、VKontakte、TikTok）联系运营方。用户在私信中提供联系方式，即表示自愿同意就许可事宜进行沟通。"
      },
      s5: {
        heading: "[ 数据本地化与存储安全 ]",
    ...
    terms: {
      ...
      s2: {
        ...
        noticeLabel: "重要法律声明：",
        noticeBody: "TrustNode 软件在相关监管要求下的法律地位目前正在审查中。详细信息将在咨询专业法律顾问后公布。"
      },
      s3: {
        heading: "[ 三、知识产权 ]",
      ...
      s4: {
        heading: "[ 四、许可证使用规则 ]",
        body: "付费抢先体验仅依据在安装软件时以电子方式签署或接受的单独最终用户许可协议（EULA）授予。禁止将 TrustNode 软件用于非法拦截第三方流量，或在俄罗斯电信网络中从事任何其他违法行为。"
      },
      s5: {
        heading: "[ 五、协议变更 ]",
  ...
  security: {
    ...
    complianceText: "TrustNode 软件在相关监管要求下的法律地位目前正在审查中。",
    features: [
      {
        title: "VAULT 加密存储",
  ...
  kira: {
    title: "KIRA 语音助手",
    subtitle: "开发中的智能语音分析回路 — 计划直接在手机运行内存中运行",
    badge: "项目规划：KIRA",
    features: [
      {
        title: "本地意图分类器 — 路线图",
        desc: "路线图：基于主 rubert-tiny2 的微调附加组件未来将识别 15-20 个特定安全意图，仅增加约 200 KB 的模型权重。"
      },
      {
        title: "100% 离线执行 — 路线图",
        desc: "路线图：无需云端大模型 API，所有语义结构和应答模板未来将打包在应用中，以超低延迟离线运行。"
      },
      {
        title: "先进训练数据集",
        desc: "欺诈计划的合成对话已经在 Google Colab 中使用 Llama 3.1 和 Qwen2.5 生成 — 这部分工作正在进行中。"
      }
    ]
  },
  explore: {
  ...
  earlyAccessPage: {
    ...
    subtitle: "选择我们的早期访问礼包之一，成为下一代安全社区的一员",
    badge: "早期访问 // 预购礼包",
    pkgPriorityTitle: "优先访问",
    pkgPriorityDesc: "抢先体验 TrustNode v1, v3 和 Kira + 优先参与未来模块的封闭测试。",
    pkgStandardTitle: "标准访问",
    pkgStandardDesc: "官方发布后获得 TrustNode v1 和 v3 授权。",
    pkgBasicTitle: "基础访问",
    pkgBasicDesc: "体验 TrustNode v1 基础安全防护。",
    pricePriority: "599₽",
    priceStandard: "299₽",
    priceBasic: "免费",
    ...
    ticketReadyInstruction: "复制下方门票 ID 并前往支付以完成注册。",
    btnGoToPayment: "前往支付",
    paymentDisclaimer: "支付通过安全的外部网关处理。您的数据受到保护。",
    selectedPackageLabel: "已选礼包"
  },
  comparisonPage: {
    title: "Honest Comparison",
    subtitle: "An objective comparative analysis of TrustNode vs leading global security solutions",
...
const tr: Translations = {
  ...
  how: {
    ...
    layers: [
      ...
      {
        name: "Davranışsal analiz — patent başvurusuna göre",
        tech: "Bağlama Duyarlı Durum Makinesi · geliştirme aşamasında",
        desc: "Yol haritası: etkileşim dinamiklerini izleyecek — yazma hızı, arama sırasında bankacılık uygulamalarına geçiş sıklığı, anormal gecikmeler ve dikkat tutma kalıpları."
      },
      {
        name: "PHANTOM konsensüsü — patent başvurusuna göre",
        tech: "Konsensüs Oylama Motoru · geliştirme aşamasında",
        desc: "Yol haritası: tüm katmanların çıktılarına göre nihai ağırlıklı kararı verecek, saldırı şüphesinde arayüzü kilitleyecek, kullanıcıyı uyaracak ve güvenilen kişiye bildirim gönderecek."
      }
    ],
    usp: [
      {
    ...
    sevenLayers: [
      ...
      {
        name: "Sosyal Mühendislik (Social Eng. Layer) — patent başvurusuna göre",
        tech: "DeGenome (18 Primitives) · geliştirme aşamasında",
        desc: "Yol haritası: 18 ilkel öğeden oluşan DeGenome taksonomisiyle manipülasyon taktiklerini tanımlayacak — yapay aciliyet, baskılı konuşma, korku tetikleyicileri ve izole etme talepleri."
      },
      {
        name: "Davranışsal Denetim (Behavioral Layer) — patent başvurusuna göre",
        tech: "Context-Aware State Machine · geliştirme aşamasında",
        desc: "Yol haritası: canlı kullanıcı etkileşimlerini sürekli izleyecek — yazma ritmi, bilişsel gecikmeler ve finansal/arama uygulamaları arasındaki geçiş sıklıkları."
      },
      {
        name: "İtibar Doğrulama (Reputation Layer) — patent başvurusuna göre",
        tech: "PCD Identity Profiles · geliştirme aşamasında",
        desc: "Yol haritası: arayan kişinin özelliklerini kurumsal kimlik profilleriyle (PCD) çapraz kontrol ederek uyumsuzlukları belirleyecek."
      },
      {
        name: "Mutabakat Kararı (Consensus Agent) — patent başvurusuna göre",
        tech: "Consensus Voting Engine · geliştirme aşamasında",
        desc: "Yol haritası: özel bir mutabakat algoritması (JudgeAgent) tüm seviyelerden risk belirteçlerini toplayarak yürütmeleri kilitleyecek ve uyarılar gönderecek."
      },
      {
        name: "Bağışıklık Belleği (Immune Memory) — patent başvurusuna göre",
        tech: "Adaptive Incident Shield · geliştirme aşamasında",
        desc: "Yol haritası: yerelleştirilmiş güvenli saldırı deposu, son tehditlere dayanarak güvenlik filtrelerinin cihaz içi ayarlanmasını sağlayacak."
      }
    ],
    btnSimplified: "Basitleştirilmiş Görünüm",
    btnAdvanced: "Patent Başvurusu PHANTOM 2.0 Mimarisi (Yol Haritası, 7 Katman)",
    pipelineHeader: "Patent Başvurusu PHANTOM 2.0 Mimarisi — Yol Haritası"
  },
  trust: {
    badge: "Bilimsel Doğrulama & İtibar",
    title: "Bilimsel",
    titleHighlight: "tanınma",
  ...
  legal: {
    ...
    privacy: {
      s1: {
        ...
        body: "Bu Kişisel Verilerin İşlenmesi Politikası, 27.07.2006 tarihli ve 152-FZ sayılı \"Kişisel Veriler Hakkında\" Rusya Federal Kanunu gerekliliklerine uygun olarak hazırlanmıştır. Kullanıcıların kişisel verilerinin işlenme usullerini ve TrustNode Protocol proje ekibi (bundan böyle \"Veri Sorumlusu\" olarak anılacaktır) tarafından alınan veri güvenliği önlemlerini tanımlar."
      },
      s2: {
        heading: "[ KUBBE PRENSİBİ: GİZLİLİK İÇİN %100 GÜVENLİ ]",
        noticeLabel: "Kritik Uyarı:",
        noticeBody: "Bileşen ayrımı: 1) TrustNode mobil uygulaması cihazınızda %100 yerel olarak çalışır; tüm koruyucu yapay zeka mekanizmaları, trafiğinizi veya dosyalarınızı sunucularımıza göndermeden akıllı telefonunuzun işlemcisinde yürütülür. 2) Bu web sitesi (bekleme listesi formu), yalnızca erken erişim hakkında sizi bilgilendirmek için gönderdiğiniz iletişim adresini (E-posta veya Telegram) toplar. Bu veriler sunucuda güvenli bir şekilde saklanır ve istediğiniz zaman tamamen silinmesini talep edebilirsiniz."
      },
      s3: {
      ...
      s4: {
        heading: "[ VERİ AKTARIMI VE VERİ SORUMLUSUYLA İLETİŞİM ]",
        body: "Sitede standart abonelik veri tabanlarını kullanmayı bıraktık. Erken erişim için Veri Sorumlusu ile iletişim, tamamen kullanıcının inisiyatifiyle, yalnızca üçüncü taraf güvenli mesajlaşma uygulamaları ve sosyal platformlar (Telegram, VKontakte, TikTok) aracılığıyla gerçekleştirilir. Kişisel yazışmalar kapsamında iletişim bilgilerini ileterek kullanıcı, lisans sağlanması konusundaki iletişim talebine gönüllü muvafakatini beyan etmiş olur."
      },
      s5: {
    ...
    terms: {
      ...
      s2: {
        ...
        noticeBody: "TrustNode yazilimi'nin ilgili mevzuat gereklilikleri karsisindaki yasal durumu su anda incelenmektedir. Ayrintili bilgi, yetkili bir hukuk danismanina danisildiktan sonra yayinlanacaktir."
      },
      s3: {
      ...
      s4: {
        ...
        body: "Erken ücretli erişim, yalnızca yazılımın kurulumu sırasında elektronik olarak imzalanan veya kabul edilen bireysel kullanıcı lisans sözleşmesi (EULA) koşullarına göre sağlanır. TrustNode yazılımının üçüncü şahısların trafiğini yasa dışı olarak ele geçirmek veya diğer hukuka aykırı eylemlerde bulunmak amacıyla kullanılması yasaktır."
      },
      s5: {
  ...
  origin: {
    ...
    timeline: [
      ...
      },
      {
        ...
        desc: "Güvenlik mimarisi ve patent başvurusu TrustNode algoritmaları, üretimi ve dağıtımı hızlandırmak için Kotlin/C++ kod oluşturma görevlerinin yapay zeka temsilcilerine devredildiği 'Mimar + AI Temsilcileri' metodolojisiyle geliştirilmiştir."
      }
    ]
  },
  security: {
    ...
    complianceText: "TrustNode yazilimi'nin ilgili mevzuat gereklilikleri karsisindaki yasal durumu su anda incelenmektedir.",
    features: [
      {
  ...
  kira: {
    ...
    subtitle: "Geliştirme aşamasında akıllı, konuşma yeteneğine sahip bir yardımcı — tamamen yerel RAM içinde çalışması planlanıyor",
    badge: "PROJE ZAMAN ÇİZELGESİ: KIRA",
    features: [
      {
        title: "Yerel Niyet Sınıflandırıcı — yol haritası",
        desc: "Yol haritası: ana rubert-tiny2 modeli üzerinde ince ayarlı bir eklenti, yalnızca ~200 KB ekleyerek 15-20 özel güvenlik niyetini çözecek."
      },
      {
        title: "%100 Çevrimdışı Çalışma — yol haritası",
        desc: "Yol haritası: harici LLM API çağrısı olmadan, tüm yanıt şablonları çevrimdışı çalışacak şekilde planlanıyor."
      },
      {
        title: "Gelişmiş Eğitim Veri Kümesi",
        desc: "Sosyal mühendislik şemalarının yapay diyalogları Google Colab'de Llama 3.1 ve Qwen2.5 ile şu anda üretiliyor — bu kısım zaten devam ediyor."
      }
    ]
  },
  explore: {
    ...
    card1Desc: "7 katmanlı PHANTOM 2.0 güvenlik kubbesinin teknik detayları (patentli mimari, bir kısmı yol haritasında) ve tamamen cihaz üzerinde çalışması planlanan akıllı sesli asistan KIRA.",
    card1Btn: "Teknolojiyi İncele →",
    card2Title: "Kanıtlanmış Başarı",
    card2Badge: "PATENT & ÖDÜLLER",
    card2Desc: "Patent başvurusu, bölgesel araştırma birinciliği, Moskova ulusal finali ve projemizin gelişim serüveni.",
  ...
  earlyAccessPage: {
    ...
    subtitle: "Erken erişim paketlerimizden birini seçin ve yeni nesil güvenlik topluluğunun parçası olun",
    badge: "ERKEN ERİŞİM // ÖN SİPARİŞ PAKETLERİ",
    pkgPriorityTitle: "Öncelikli Erişim",
    pkgPriorityDesc: "TrustNode v1, v3, Kira erişimi — en erken + gelecek modüllerin kapalı beta testlerine öncelikli katılım.",
    pkgStandardTitle: "Standart Erişim",
    pkgStandardDesc: "Resmi sürümden sonra TrustNode v1 ve v3 lisansı.",
    pkgBasicTitle: "Temel Erişim",
    pkgBasicDesc: "Temel TrustNode v1 korumasına erişim.",
    pricePriority: "599₽",
    priceStandard: "299₽",
    priceBasic: "Ücretsiz",
    ...
    ticketReadyInstruction: "Aşağıdaki bilet kimliğini kopyalayın ve kaydı tamamlamak için ödemeye devam edin.",
    btnGoToPayment: "Ödemeye Devam Et",
    paymentDisclaimer: "Ödeme güvenli bir harici ağ geçidi üzerinden işlenir. Verileriniz korunmaktadır.",
    selectedPackageLabel: "Seçilen Paket"
  },
  comparisonPage: {
    title: "Honest Comparison",
    subtitle: "An objective comparative analysis of TrustNode vs leading global security solutions",
...
const hi: Translations = {
  ...
  how: {
    ...
    layers: [
      ...
      {
        name: "व्यवहार विश्लेषण — पेटेंट आवेदन के अनुसार",
        tech: "कॉन्टेक्स्ट-अवेयर स्टेट मशीन · विकासाधीन",
        desc: "रोडमैप: भविष्य में इंटरैक्शन की गतिशीलता ट्रैक की जाएगी — टाइपिंग स्पीड, बैंकिंग ऐप्स पर स्विच करने की आवृत्ति, असामान्य देरी और ध्यान बनाए रखने के पैटर्न।"
      },
      {
        name: "PHANTOM कंसेंसस — पेटेंट आवेदन के अनुसार",
        tech: "कंसेंसस वोटिंग इंजन · विकासाधीन",
        desc: "रोडमैप: सभी परतों के परिणामों के आधार पर अंतिम भारांकित निर्णय लिया जाएगा, हमले की आशंका पर इंटरफ़ेस लॉक होगा और विश्वसनीय संपर्क को सूचना भेजी जाएगी।"
      }
    ],
    usp: [
      {
    ...
    sevenLayers: [
      ...
      {
        name: "सोशल इंजीनियरिंग (Social Eng. Layer) — पेटेंट आवेदन के अनुसार",
        tech: "DeGenome (18 प्रिमिटिव्स) · विकासाधीन",
        desc: "रोडमैप: 18 प्रिमिटिव्स के DeGenome वर्गीकरण से हेरफेर की रणनीति पहचानी जाएगी — कृत्रिम तात्कालिकता, दबाव वाला भाषण, डर के ट्रिगर्स और अलगाव के अनुरोध।"
      },
      {
        name: "व्यवहार ऑडिटिंग (Behavioral Layer) — पेटेंट आवेदन के अनुसार",
        tech: "Context-Aware State Machine · विकासाधीन",
        desc: "रोडमैप: लाइव उपयोगकर्ता इंटरैक्शन ट्रैक किया जाएगा — टाइपिंग की गति, प्रसंस्करण में देरी, और वित्तीय व कॉलिंग ऐप के बीच स्विच करने की आवृत्ति।"
      },
      {
        name: "प्रतिष्ठा सत्यापन (Reputation Layer) — पेटेंट आवेदन के अनुसार",
        tech: "PCD Identity Profiles · विकासाधीन",
        desc: "रोडमैप: कॉलर के लक्षणों को कॉर्पोरेट पहचान प्रोफाइल (PCD) से क्रॉस-चेक कर आधिकारिक प्रोटोकॉल से बेमेल की पहचान की जाएगी।"
      },
      {
        name: "सर्वसम्मति समाधान (Consensus Agent) — पेटेंट आवेदन के अनुसार",
        tech: "Consensus Voting Engine · विकासाधीन",
        desc: "रोडमैप: एक JudgeAgent सर्वसम्मति इंजन सभी स्तरों से जोखिम मार्कर एकत्र कर निष्पादन को लॉक करेगा और विश्वसनीय संपर्कों को सूचित करेगा।"
      },
      {
        name: "प्रतिरक्षा मेमोरी (Immune Memory) — पेटेंट आवेदन के अनुसार",
        tech: "Adaptive Incident Shield · विकासाधीन",
        desc: "रोडमैप: स्थानीय सुरक्षित हमला रिपॉजिटरी हाल के खतरों के आधार पर ऑन-डिवाइस सुरक्षा फ़िल्टर को फाइन-ट्यून करेगी।"
      }
    ],
    btnSimplified: "सरलीकृत दृश्य",
    btnAdvanced: "PHANTOM 2.0 पेटेंट आवेदन आर्किटेक्चर (रोडमैप, 7 परतें)",
    pipelineHeader: "पेटेंट आवेदन PHANTOM 2.0 आर्किटेक्चर — विकास रोडमैप"
  },
  trust: {
    badge: "वैज्ञानिक सत्यापन और मान्यता",
    title: "वैज्ञानिक",
    titleHighlight: "मान्यता",
  ...
  legal: {
    ...
    privacy: {
      s1: {
        ...
        body: "यह गोपनीयता नीति 27 जुलाई 2006 के रूसी संघीय क़ानून संख्या 152-FZ \"व्यक्तिगत डेटा पर\" के अनुसार तैयार की गई है। यह तय करती है कि TrustNode Protocol प्रोजेक्ट टीम (\"ऑपरेटर\") यूज़र के व्यक्तिगत डेटा को कैसे प्रोसेस करती है और उसकी सुरक्षा के लिए क्या उपाय अपनाती है।"
      },
      s2: {
        heading: "[ डोम सिद्धांत: आपकी निजता के लिए 100% सुरक्षित ]",
        noticeLabel: "अत्यंत महत्वपूर्ण सूचना:",
        noticeBody: "डेटा संग्रह विवरण: 1) TrustNode मोबाइल ऐप आपके डिवाइस पर 100% स्थानीय रूप से चलता है; सभी सुरक्षात्मक AI तंत्र आपके ट्रैफ़िक या फ़ाइलों को हमारे सर्वर पर भेजे बिना आपके स्मार्टफ़ोन के CPU पर निष्पादित होते हैं। 2) यह वेबसाइट (प्रतीक्षा सूची फ़ॉर्म) आपके द्वारा सबमिट किए गए संपर्क हैंडल (ई-मेल या टेलीग्राम) को केवल आपको प्रारंभिक पहुंच के बारे में सूचित करने के लिए एकत्र करती है। यह डेटा सर्वर पर संग्रहीत होता है और आप किसी भी समय इसे पूरी तरह से हटाने का अनुरोध कर सकते हैं।"
      },
      s3: {
      ...
      s4: {
        heading: "[ डेटा ट्रांसफ़र और ऑपरेटर से संपर्क ]",
        body: "हमने साइट पर मानक सब्सक्रिप्शन डेटाबेस का इस्तेमाल छोड़ दिया है। अर्ली एक्सेस के लिए ऑपरेटर से संपर्क यूज़र की अपनी पहल पर, केवल थर्ड-पार्टी सुरक्षित मैसेंजर और सोशल प्लेटफ़ॉर्म (Telegram, VKontakte, TikTok) के ज़रिए होता है। डायरेक्ट मैसेज में अपना संपर्क विवरण देकर, यूज़र लाइसेंस से जुड़े संवाद के लिए अपनी स्वैच्छिक सहमति देता है।"
      },
      s5: {
    ...
    terms: {
      ...
      s2: {
        ...
        noticeBody: "लागू नियामक आवश्यकताओं के तहत TrustNode सॉफ़्टवेयर की कानूनी स्थिति की वर्तमान में समीक्षा की जा रही है। योग्य कानूनी सलाहकार से परामर्श के बाद विस्तृत जानकारी प्रकाशित की जाएगी।"
      },
      s3: {
  ...
  security: {
    ...
    complianceText: "लागू नियामक आवश्यकताओं के तहत TrustNode सॉफ़्टवेयर की कानूनी स्थिति की वर्तमान में समीक्षा की जा रही है।",
    features: [
      {
  ...
  kira: {
    ...
    subtitle: "एक बुद्धिमान भाषण-सक्षम साथी जो विकासाधीन है — योजना है कि यह पूरी तरह से स्थानीय रैम के भीतर चलेगा",
    badge: "परियोजना समयरेखा: KIRA",
    features: [
      {
        title: "स्थानीय इरादा वर्गीकारक — रोडमैप",
        desc: "रोडमैप: मुख्य rubert-tiny2 पर आधारित फाइन-ट्यून्ड ऐड-ऑन केवल ~200 KB के साथ 15-20 विशिष्ट सुरक्षा इरादों को हल करेगा।"
      },
      {
        title: "100% ऑफ़लाइन निष्पादन — रोडमैप",
        desc: "रोडमैप: बाहरी LLM API कॉल के बिना, प्रतिक्रिया टेम्पलेट पूरी तरह ऑफ़लाइन कम विलंबता के साथ काम करेंगे।"
      },
      {
        title: "उन्नत प्रशिक्षण डेटासेट",
        desc: "धोखाधड़ी योजनाओं के सिंथेटिक संवाद पहले से ही Google Colab में Llama 3.1 और Qwen2.5 का उपयोग करके तैयार किए जा रहे हैं — यह हिस्सा अभी चल रहा है।"
      }
    ]
  },
  explore: {
  ...
  earlyAccessPage: {
    ...
    subtitle: "प्रारंभिक पहुँच पैकेजों में से एक चुनें और अगली पीढ़ी के सुरक्षा समुदाय का हिस्सा बनें",
    badge: "प्रारंभिक पहुँच // प्री-ऑर्डर पैकेज",
    pkgPriorityTitle: "प्राथमिकता पहुँच",
    pkgPriorityDesc: "TrustNode v1, v3, Kira तक सबसे पहले पहुँच + भविष्य के मॉड्यूल के बंद बीटा परीक्षण में प्राथमिकता भागीदारी।",
    pkgStandardTitle: "मानक पहुँच",
    pkgStandardDesc: "आधिकारिक रिलीज के बाद TrustNode v1 और v3 के लिए लाइसेंस।",
    pkgBasicTitle: "बुनियादी पहुँच",
    pkgBasicDesc: "बुनियादी TrustNode v1 सुरक्षा तक पहुँच।",
    pricePriority: "599₽",
    priceStandard: "299₽",
    priceBasic: "निःशुल्क",
    ...
    ticketReadyInstruction: "नीचे दिए गए टिकट आईडी को कॉपी करें और पंजीकरण पूरा करने के लिए भुगतान पर आगे बढ़ें।",
    btnGoToPayment: "भुगतान के लिए आगे बढ़ें",
    paymentDisclaimer: "भुगतान एक सुरक्षित बाहरी गेटवे के माध्यम से संसाधित किया जाता है। आपका डेटा सुरक्षित है।",
    selectedPackageLabel: "चयनित पैकेज"
  },
  comparisonPage: {
    title: "Honest Comparison",
    subtitle: "An objective comparative analysis of TrustNode vs leading global security solutions",
...
const ar: Translations = {
  ...
  how: {
    ...
    layers: [
      ...
      {
        name: "تحليل السلوك — وفقًا لطلب براءة الاختراع",
        tech: "آلة حالة واعية بالسياق · قيد التطوير",
        desc: "خارطة الطريق: ستتابع ديناميكية التفاعل مستقبلاً — سرعة الكتابة، وتكرار التبديل إلى تطبيقات البنوك، والتأخيرات غير الطبيعية، وأنماط شدّ الانتباه."
      },
      {
        name: "إجماع PHANTOM — وفقًا لطلب براءة الاختراع",
        tech: "محرك التصويت بالإجماع · قيد التطوير",
        desc: "خارطة الطريق: سيتخذ القرار النهائي الموزون بناءً على مخرجات جميع الطبقات، ويقفل الواجهة عند الاشتباه بهجوم، وينبّه المستخدم وجهة الاتصال الموثوقة."
      }
    ],
    usp: [
      {
    ...
    sevenLayers: [
      ...
      {
        name: "الهندسة الاجتماعية (Social Eng. Layer) — وفقًا لطلب براءة الاختراع",
        tech: "DeGenome (18 عنصرًا أساسيًا) · قيد التطوير",
        desc: "خارطة الطريق: ستحدد تكتيكات التلاعب باستخدام تصنيف DeGenome من 18 عنصرًا — الاستعجال المصطنع، وخطاب الضغط، ومثيرات الخوف، وطلبات العزل."
      },
      {
        name: "التدقيق السلوكي (Behavioral Layer) — وفقًا لطلب براءة الاختراع",
        tech: "Context-Aware State Machine · قيد التطوير",
        desc: "خارطة الطريق: سيتتبع تفاعلات المستخدم المباشرة — سرعة الكتابة، والتأخير المعرفي، وتكرار التنقل بين التطبيقات المصرفية وتطبيقات الاتصال."
      },
      {
        name: "التحقق من السمعة (Reputation Layer) — وفقًا لطلب براءة الاختراع",
        tech: "PCD Identity Profiles · قيد التطوير",
        desc: "خارطة الطريق: سيطابق سمات المتصل مع ملفات الهوية المؤسسية (PCD) لاكتشاف عدم التطابق مع البروتوكولات الرسمية."
      },
      {
        name: "حل التوافق (Consensus Agent) — وفقًا لطلب براءة الاختراع",
        tech: "Consensus Voting Engine · قيد التطوير",
        desc: "خارطة الطريق: سيجمع محرك توافق JudgeAgent مؤشرات الخطر من جميع المستويات لقفل الواجهة وتنبيه المستخدم وجهات الاتصال الموثوقة."
      },
      {
        name: "الذاكرة المناعية (Immune Memory) — وفقًا لطلب براءة الاختراع",
        tech: "Adaptive Incident Shield · قيد التطوير",
        desc: "خارطة الطريق: مستودع محلي آمن للهجمات سيتيح ضبط فلاتر الأمان بناءً على التهديدات المخففة مؤخرًا."
      }
    ],
    btnSimplified: "عرض مبسط",
    btnAdvanced: "بنية PHANTOM 2.0 قيد تسجيل براءة اختراع (خارطة طريق، 7 طبقات)",
    pipelineHeader: "بنية PHANTOM 2.0 (طلب براءة اختراع) — خارطة الطريق"
  },
  trust: {
  ...
  legal: {
    ...
    privacy: {
      s1: {
        heading: "[ أحكام عامة ]",
        body: "أُعدّت سياسة الخصوصية هذه وفقًا لمتطلبات القانون الفيدرالي الروسي رقم 152-FZ «بشأن البيانات الشخصية» الصادر بتاريخ 27 يوليو 2006. وهي تحدد كيفية معالجة فريق مشروع TrustNode Protocol (يُشار إليه فيما يلي بـ«المشغّل») للبيانات الشخصية للمستخدمين والتدابير المتخذة لحمايتها."
      },
      s2: {
        heading: "[ مبدأ القبة: حماية كاملة بنسبة 100% لخصوصيتك ]",
        noticeLabel: "إشعار بالغ الأهمية:",
        noticeBody: "توضيح البيانات: 1) يعمل تطبيق TrustNode للهاتف المحمول محليًا بنسبة 100% على جهازك؛ تنفذ جميع آليات الذكاء الاصطناعي الوقائية على معالج هاتفك الذكي دون إرسال بيانات المرور أو الملفات إلى خوادمنا. 2) يجمع هذا الموقع الإلكتروني (نموذج قائمة الانتظار) فقط وسيلة الاتصال (البريد الإلكتروني أو تيليجرام) التي ترسلها لإعلامك بالوصول المبكر. يتم تخزين هذه البيانات على الخادم، ويمكنك طلب حذفها بالكامل في أي وقت."
      },
      s3: {
      ...
      s4: {
        heading: "[ نقل البيانات والتواصل مع المشغّل ]",
        body: "لقد استغنينا عن قواعد بيانات الاشتراك المعتادة على الموقع. يتم التواصل مع المشغّل للحصول على الوصول المبكر بمبادرة من المستخدم حصريًا عبر تطبيقات مراسلة آمنة تابعة لجهات خارجية ومنصات تواصل اجتماعي (تيليجرام، VKontakte، TikTok). وبمشاركة بيانات التواصل الخاصة به في رسالة مباشرة، يُعبّر المستخدم عن موافقته الطوعية على التواصل بشأن الحصول على الترخيص."
      },
      s5: {
    ...
    terms: {
      ...
      s2: {
        ...
        noticeBody: "الوضع القانوني لبرنامج TrustNode بموجب المتطلبات التنظيمية المعمول بها قيد المراجعة حاليا. سيتم نشر معلومات مفصلة بعد استشارة مستشار قانوني مؤهل."
      },
      s3: {
      ...
      s4: {
        ...
        body: "يُمنح الوصول المبكر المدفوع حصريًا وفق شروط اتفاقية ترخيص مستخدم نهائي فردية (EULA)، تُوقَّع أو تُقبَل إلكترونيًا عند تثبيت البرنامج. يُحظر استخدام برنامج TrustNode لاعتراض حركة مرور أطراف ثالثة بشكل غير قانوني أو أي نشاط آخر غير قانوني على شبكات الاتصالات الروسية."
      },
      s5: {
  ...
  security: {
    ...
    complianceText: "الوضع القانوني لبرنامج TrustNode بموجب المتطلبات التنظيمية المعمول بها قيد المراجعة حاليا.",
    features: [
      {
  ...
  kira: {
    ...
    subtitle: "دائرة كلامية ذكية قيد التطوير — من المخطط أن تعمل مباشرة في ذاكرة الوصول العشوائي (RAM) لهاتفك",
    badge: "خطة البرنامج: KIRA",
    features: [
      {
        title: "مصنف النوايا المحلي — خارطة طريق",
        desc: "خارطة الطريق: ستتعرف الإضافة المبنية فوق rubert-tiny2 على 15-20 نية أمنية متخصصة، بإضافة ~200 كيلوبايت فقط لوزن النموذج."
      },
      {
        title: "تشغيل أوفلاين بنسبة 100% — خارطة طريق",
        desc: "خارطة الطريق: دون اتصالات بنماذج لغوية سحابية، ستعمل قوالب الاستجابة بالكامل دون اتصال بزمن انتقال منخفض جدًا."
      },
      {
        title: "مجموعات البيانات التدريبية المتقدمة",
        desc: "يتم بالفعل إنشاء حوارات تركيبية لخطط الاحتيال في Google Colab باستخدام Llama 3.1 و Qwen2.5 — هذا الجزء من العمل جارٍ حاليًا."
      }
    ]
  },
  explore: {
    ...
    card2Desc: "طلبات براءات الاختراع، المركز الأول في الأبحاث الإقليمية، وتاريخ تطوير المشروع.",
  ...
  earlyAccessPage: {
    ...
    subtitle: "اختر إحدى باقات الوصول المبكر لتصبح جزءاً من مجتمع الأمان من الجيل القادم",
    badge: "الوصول المبكر // باقات الطلب المسبق",
    pkgPriorityTitle: "وصول ذو أولوية",
    pkgPriorityDesc: "وصول إلى TrustNode v1 و v3 و Kira في أبكر وقت + مشاركة ذات أولوية في الاختبار التجريبي المغلق للوحدات المستقبلية.",
    pkgStandardTitle: "وصول قياسي",
    pkgStandardDesc: "ترخيص لـ TrustNode v1 و v3 بعد الإصدار الرسمي.",
    pkgBasicTitle: "وصول أساسي",
    pkgBasicDesc: "الوصول إلى حماية TrustNode v1 الأساسية.",
    pricePriority: "599₽",
    priceStandard: "299₽",
    priceBasic: "مجاني",
    ...
    ticketReadyInstruction: "انسخ معرف التذكرة أدناه وتابع إلى الدفع لإكمال التسجيل.",
    btnGoToPayment: "الذهاب إلى الدفع",
    paymentDisclaimer: "يتم معالجة الدفع عبر بوابة خارجية آمنة. بياناتك محمية.",
...
const pt: Translations = {
  ...
  how: {
    ...
    layers: [
      ...
      {
        name: "Análise comportamental — conforme pedido de patente",
        tech: "Máquina de estados sensível ao contexto · em desenvolvimento",
        desc: "Roadmap: monitorará a dinâmica da interação — velocidade de digitação, frequência de troca para apps bancários, atrasos anômalos e padrões de retenção de atenção."
      },
      {
        name: "Consenso PHANTOM — conforme pedido de patente",
        tech: "Motor de votação por consenso · em desenvolvimento",
        desc: "Roadmap: tomará a decisão final ponderada com base nas saídas de todas as camadas, bloqueará a interface ao suspeitar de um ataque e notificará um contato de confiança."
      }
    ],
    usp: [
      {
    ...
    sevenLayers: [
      ...
      {
        name: "Engenharia social (Social Eng. Layer) — conforme pedido de patente",
        tech: "DeGenome (18 primitivas) · em desenvolvimento",
        desc: "Roadmap: identificará táticas de manipulação usando a taxonomia DeGenome de 18 primitivas — pressa artificial, intimidação, exigências de confidencialidade e pressão emocional."
      },
      {
        name: "Análise comportamental (Behavioral Layer) — conforme pedido de patente",
        tech: "Context-Aware State Machine · em desenvolvimento",
        desc: "Roadmap: monitorará a dinâmica da interação em tempo real — velocidade de digitação, atrasos de resposta e frequência de troca entre apps durante uma chamada."
      },
      {
        name: "Verificação de reputação (Reputation Layer) — conforme pedido de patente",
        tech: "PCD Identity Profiles · em desenvolvimento",
        desc: "Roadmap: comparará as características do chamador com perfis de identidade corporativa (PCD), identificando padrões que não condizem com protocolos oficiais."
      },
      {
        name: "Consenso PHANTOM (Consensus Agent) — conforme pedido de patente",
        tech: "Consensus Voting Engine · em desenvolvimento",
        desc: "Roadmap: o mecanismo JudgeAgent ponderará as avaliações de todos os níveis, bloqueando ações perigosas e notificando contatos de confiança."
      },
      {
        name: "Memoria imune (Immune Memory) — conforme pedido de patente",
        tech: "Adaptive Incident Shield · em desenvolvimento",
        desc: "Roadmap: memória isolada de ataques que adaptará localmente os perfis de proteção com base em incidentes recentes."
      }
    ],
    btnSimplified: "Estrutura simplificada",
    btnAdvanced: "Arquitetura PHANTOM 2.0 (conforme pedido de patente, roadmap, 7 camadas)",
    pipelineHeader: "Arquitetura PHANTOM 2.0 conforme pedido de patente — plano de desenvolvimento"
  },
  trust: {
  ...
  legal: {
    ...
    privacy: {
      s1: {
        ...
        body: "Esta Política de Privacidade é elaborada em conformidade com a Lei Federal Russa nº 152-FZ \"Sobre Dados Pessoais\", de 27 de julho de 2006. Ela define como a equipe do projeto TrustNode Protocol (o \"Operador\") processa os dados pessoais dos usuários e as salvaguardas aplicadas."
      },
      s2: {
        heading: "[ O PRINCÍPIO DA CÚPULA: 100% SEGURO PARA SUA PRIVACIDADE ]",
        noticeLabel: "Aviso crítico:",
        noticeBody: "Separação de entidades: 1) O aplicativo móvel TrustNode funciona 100% localmente no seu dispositivo; todos os mecanismos de IA de proteção são executados na CPU do seu smartphone sem enviar seu tráfego ou arquivos para nossos servidores. 2) Este site (formulário de lista de espera) coleta apenas o contato (E-mail ou Telegram) que você envia para notificá-lo sobre o acesso antecipado. Esses dados são armazenados no servidor e você pode solicitar sua exclusão completa a qualquer momento."
      },
      s3: {
      ...
      s4: {
        heading: "[ TRANSFERÊNCIA DE DADOS E CONTATO COM O OPERADOR ]",
        body: "Deixamos de lado os bancos de dados de assinatura padrão no site. O contato com o Operador para acesso antecipado ocorre por iniciativa do usuário, exclusivamente por meio de mensageiros seguros de terceiros e plataformas sociais (Telegram, VKontakte, TikTok). Ao compartilhar dados de contato em uma mensagem direta, o usuário dá consentimento voluntário para comunicação sobre licenciamento."
      },
      s5: {
    ...
    terms: {
      ...
      s2: {
        ...
        noticeBody: "O status legal do software TrustNode em relacao aos requisitos regulatorios aplicaveis esta atualmente em analise. Informacoes detalhadas serao publicadas apos consulta a um advogado qualificado."
      },
      s3: {
      ...
      s5: {
        ...
        body: "A administração do site notificará os usuários sobre as alterações publicando a nova versão nesta página. A versão atual do Acordo está sempre disponível nesta página."
      }
    }
  },
  pageNames: {
  ...
  security: {
    ...
    complianceText: "O status legal do software TrustNode em relacao aos requisitos regulatorios aplicaveis esta atualmente em analise.",
    features: [
      {
  ...
  kira: {
    ...
    subtitle: "Um circuito de fala inteligente em desenvolvimento — com plano de operar diretamente na memória RAM do celular",
    badge: "PLANO DO PROJETO: KIRA",
    features: [
      {
        title: "Classificador de Intenção Local — roadmap",
        desc: "Roadmap: uma extensão ajustada sobre a rede rubert-tiny2 reconhecerá de 15 a 20 intenções de segurança específicas, adicionando apenas ~200 KB de peso ao modelo."
      },
      {
        title: "Execução 100% Off-line — roadmap",
        desc: "Roadmap: sem chamadas para LLMs em nuvem, os modelos de resposta funcionarão totalmente off-line com latência ultra baixa."
      },
      {
        title: "Dataset de Treinamento Avançado",
        desc: "Diálogos sintéticos de esquemas de fraude já estão sendo gerados no Google Colab usando Llama 3.1 e Qwen2.5 — essa parte do trabalho já está em andamento."
      }
    ]
  },
  explore: {
  ...
  earlyAccessPage: {
    ...
    subtitle: "Escolha um de nossos pacotes de acesso antecipado e faça parte da comunidade de segurança de próxima geração",
    badge: "ACESSO ANTECIPADO // PACOTES DE PRÉ-VENDA",
    pkgPriorityTitle: "Acesso Prioritário",
    pkgPriorityDesc: "Acesso ao TrustNode v1, v3, Kira — o mais cedo de todos + participação prioritária em testes beta fechados de futuros módulos.",
    pkgStandardTitle: "Acesso Padrão",
    pkgStandardDesc: "Licença para TrustNode v1 e v3 após o lançamento oficial.",
    pkgBasicTitle: "Acesso Básico",
    pkgBasicDesc: "Acesso à proteção básica do TrustNode v1.",
    pricePriority: "599₽",
    priceStandard: "299₽",
    priceBasic: "Grátis",
    ...
    ticketReadyInstruction: "Copie o ID do bilhete abaixo e prossiga para o pagamento para concluir o registro.",
    btnGoToPayment: "Ir para o Pagamento",
    paymentDisclaimer: "O pagamento é processado por meio de um gateway externo seguro. Seus dados estão protegidos.",
...
const fr: Translations = {
  ...
  how: {
    ...
    layers: [
      ...
      {
        name: "Analyse comportementale — selon la demande de brevet",
        tech: "Machine à états sensible au contexte · en développement",
        desc: "Feuille de route : suivra la dynamique de l'interaction — vitesse de frappe, fréquence de bascule vers les applications bancaires, délais anormaux et schémas de rétention d'attention."
      },
      {
        name: "Consensus PHANTOM — selon la demande de brevet",
        tech: "Moteur de vote par consensus · en développement",
        desc: "Feuille de route : prendra la décision finale pondérée à partir des résultats de toutes les couches, verrouillera l'interface en cas de suspicion d'attaque et alertera un contact de confiance."
      }
    ],
    usp: [
      {
    ...
    sevenLayers: [
      ...
      {
        name: "Ingénierie sociale (Social Eng. Layer) — selon la demande de brevet",
        tech: "DeGenome (18 primitives) · en développement",
        desc: "Feuille de route : identifiera les tactiques de manipulation via la taxonomie DeGenome de 18 primitives — urgence artificielle, discours de pression, déclencheurs de peur et demandes d'isolement."
      },
      {
        name: "Analyse comportementale (Behavioral Layer) — selon la demande de brevet",
        tech: "Context-Aware State Machine · en développement",
        desc: "Feuille de route : suivra la dynamique des interactions en direct — vitesse de frappe, délais cognitifs et bascules vers les applications bancaires."
      },
      {
        name: "Vérification de réputation (Reputation Layer) — selon la demande de brevet",
        tech: "PCD Identity Profiles · en développement",
        desc: "Feuille de route : vérifiera les traits de l'appelant par rapport aux profils d'identité d'entreprise (PCD), détectant les écarts avec les protocoles officiels."
      },
      {
        name: "Résolution par consensus (Consensus Agent) — selon la demande de brevet",
        tech: "Consensus Voting Engine · en développement",
        desc: "Feuille de route : un moteur JudgeAgent agrégera les marqueurs de risque de tous niveaux pour verrouiller l'interface et alerter les contacts de confiance."
      },
      {
        name: "Mémoire immunitaire (Immune Memory) — selon la demande de brevet",
        tech: "Adaptive Incident Shield · en développement",
        desc: "Feuille de route : répertoire local sécurisé des attaques qui permettra un ajustement fin sur l'appareil selon les menaces récentes."
      }
    ],
    btnSimplified: "Structure simplifiée",
    btnAdvanced: "Architecture PHANTOM 2.0 (demande de brevet, feuille de route, 7 couches)",
    pipelineHeader: "Architecture PHANTOM 2.0 (demande de brevet) — feuille de route"
  },
  trust: {
    badge: "Validation scientifique & reconnaissance",
    title: "Reconnaissance",
    titleHighlight: "scientifique",
  ...
  legal: {
    ...
    privacy: {
      ...
      s2: {
        ...
        noticeBody: "Séparation des entités : 1) L'application mobile TrustNode fonctionne à 100 % localement sur votre appareil ; tous les mécanismes de protection IA s'exécutent sur le processeur de votre smartphone sans envoyer votre trafic ou vos fichiers sur nos serveurs. 2) Ce site web (formulaire de liste d'attente) collecte uniquement le contact (E-mail ou Telegram) que vous soumettez pour vous informer de l'accès anticipé. Ces données sont stockées sur le serveur et vous pouvez demander leur suppression complète à tout moment."
      },
      s3: {
      ...
      s4: {
        heading: "[ TRANSFERT DE DONNÉES ET CONTACT AVEC L'OPÉRATEUR ]",
        body: "Nous avons abandonné les bases de données d'abonnement classiques sur le site. Le contact avec l'Opérateur pour un accès anticipé se fait à l'initiative de l'utilisateur, exclusivement via des messageries sécurisées tierces et des plateformes sociales (Telegram, VKontakte, TikTok). En communiquant ses coordonnées dans un message privé, l'utilisateur donne son consentement volontaire pour être contacté au sujet des licences."
      },
      s5: {
    ...
    terms: {
      ...
      s2: {
        ...
        noticeBody: "Le statut juridique du logiciel TrustNode au regard des exigences reglementaires applicables est actuellement en cours d'examen. Des informations detaillees seront publiees apres consultation d'un conseiller juridique qualifie."
      },
      s3: {
      ...
      s4: {
        ...
        body: "L'accès anticipé payant est accordé exclusivement dans le cadre d'un contrat de licence utilisateur final (EULA) individuel, signé ou accepté électroniquement lors de l'installation. Il est interdit d'utiliser le logiciel TrustNode pour intercepter illégalement le trafic de tiers ou pour toute autre activité illicite sur les réseaux de télécommunications russes."
      },
      s5: {
  ...
  realDev: {
    ...
    devUi: {
      ...
      dlOnnx: "Sur l'Appareil Uniquement"
    },
    awardDetails: {
  ...
  security: {
    ...
    complianceText: "Le statut juridique du logiciel TrustNode au regard des exigences reglementaires applicables est actuellement en cours d'examen.",
    features: [
      {
  ...
  kira: {
    ...
    subtitle: "Un circuit de parole intelligent en développement — prévu pour fonctionner entièrement dans la mémoire RAM locale du smartphone",
    badge: "CALENDRIER DU PROJET : KIRA",
    features: [
      {
        title: "Classificateur d'Intents Local — feuille de route",
        desc: "Feuille de route : un module affiné au-dessus du modèle rubert-tiny2 résoudra 15 à 20 intentions de sécurité spécifiques, pour une empreinte de seulement ~200 Ko."
      },
      {
        title: "Exécution 100 % hors ligne — feuille de route",
        desc: "Feuille de route : sans appel d'API LLM externe, les modèles de réponse fonctionneront entièrement hors ligne avec une latence très basse."
      },
      {
        title: "Jeux de données d'entraînement avancés",
        desc: "Les dialogues synthétiques de schémas d'ingénierie sociale sont déjà générés dans Google Colab à l'aide de Llama 3.1 et Qwen2.5 — cette partie du travail est en cours."
      }
    ]
  },
  explore: {
  ...
  earlyAccessPage: {
    ...
    subtitle: "Choisissez l'un de nos packs d'accès anticipé et rejoignez la communauté de sécurité de nouvelle génération",
    badge: "ACCÈS ANTICIPÉ // PACKS DE PRÉCOMMANDE",
    pkgPriorityTitle: "Accès Prioritaire",
    pkgPriorityDesc: "Accès à TrustNode v1, v3, Kira — le plus tôt possible + participation prioritaire aux tests bêta fermés des futurs modules.",
    pkgStandardTitle: "Accès Standard",
    pkgStandardDesc: "Licence pour TrustNode v1 et v3 après la sortie officielle.",
    pkgBasicTitle: "Accès Basique",
    pkgBasicDesc: "Accès à la protection de base TrustNode v1.",
    pricePriority: "599₽",
    priceStandard: "299₽",
    priceBasic: "Gratuit",
    ...
    ticketReadyInstruction: "Copiez l'identifiant du billet ci-dessous et procédez au paiement pour finaliser l'inscription.",
    btnGoToPayment: "Procéder au Paiement",
    paymentDisclaimer: "Le paiement est traité via une passerelle externe sécurisée. Vos données sont protégées.",
    selectedPackageLabel: "Pack Sélectionné"
  },
  comparisonPage: {
    title: "Honest Comparison",
    subtitle: "An objective comparative analysis of TrustNode vs leading global security solutions",
...
const de: Translations = {
  ...
  how: {
    ...
    layers: [
      ...
      {
        name: "Verhaltensanalyse — laut Patentanmeldung",
        tech: "Kontextbewusste Zustandsmaschine · in Entwicklung",
        desc: "Roadmap: wird künftig die Interaktionsdynamik verfolgen — Tippgeschwindigkeit, Häufigkeit des Wechsels zu Banking-Apps, ungewöhnliche Verzögerungen und Aufmerksamkeitsmuster."
      },
      {
        name: "PHANTOM-Konsens — laut Patentanmeldung",
        tech: "Konsens-Abstimmungs-Engine · in Entwicklung",
        desc: "Roadmap: wird die endgültige gewichtete Entscheidung auf Basis aller Ebenen treffen, bei Angriffsverdacht die Oberfläche sperren und eine vertrauenswürdige Kontaktperson benachrichtigen."
      }
    ],
    usp: [
      {
    ...
    sevenLayers: [
      ...
      {
        name: "Social Engineering (Social Eng. Layer) — laut Patentanmeldung",
        tech: "DeGenome (18 Primitive) · in Entwicklung",
        desc: "Roadmap: wird Manipulationstaktiken mithilfe der DeGenome-Taxonomie von 18 Primitiven identifizieren — künstliche Dringlichkeit, Druckreden, Angstauslöser und Isolationsaufforderungen."
      },
      {
        name: "Verhaltensanalyse (Behavioral Layer) — laut Patentanmeldung",
        tech: "Context-Aware State Machine · in Entwicklung",
        desc: "Roadmap: wird Live-Nutzerinteraktionen verfolgen — Tippgeschwindigkeit, Verarbeitungsverzögerungen und Wechselhäufigkeit zu Banking-Apps."
      },
      {
        name: "Reputationsüberprüfung (Reputation Layer) — laut Patentanmeldung",
        tech: "PCD Identity Profiles · in Entwicklung",
        desc: "Roadmap: wird Anrufermerkmale mit Unternehmensidentitätsprofilen (PCD) abgleichen und Abweichungen von offiziellen Protokollen erkennen."
      },
      {
        name: "Konsens-Entscheidung (Consensus Agent) — laut Patentanmeldung",
        tech: "Consensus Voting Engine · in Entwicklung",
        desc: "Roadmap: eine JudgeAgent-Engine wird Risikomarker aus allen Ebenen aggregieren, die Ausführung sperren und Vertrauenskontakte benachrichtigen."
      },
      {
        name: "Immungedächtnis (Immune Memory) — laut Patentanmeldung",
        tech: "Adaptive Incident Shield · in Entwicklung",
        desc: "Roadmap: ein lokaler sicherer Angriffsspeicher wird die geräteinterne Feinabstimmung von Sicherheitsfiltern basierend auf kürzlichen Bedrohungen ermöglichen."
      }
    ],
    btnSimplified: "Vereinfachte Struktur",
    btnAdvanced: "Patentangemeldete PHANTOM 2.0 Architektur (Roadmap, 7 Schichten)",
    pipelineHeader: "Patentangemeldete PHANTOM 2.0 Architektur — Entwicklungs-Roadmap"
  },
  trust: {
    badge: "Wissenschaftliche Validierung & Anerkennung",
    title: "Wissenschaftliche",
    titleHighlight: "Anerkennung",
  ...
  legal: {
    ...
    privacy: {
      s1: {
        ...
        body: "Diese Datenschutzerklärung wurde in Übereinstimmung mit dem russischen Bundesgesetz Nr. 152-FZ „Über personenbezogene Daten“ vom 27. Juli 2006 erstellt. Sie legt fest, wie das TrustNode-Protocol-Projektteam (der „Betreiber“) personenbezogene Nutzerdaten verarbeitet und welche Schutzmaßnahmen gelten."
      },
      s2: {
        heading: "[ DAS KUPPEL-PRINZIP: 100 % SICHER FÜR IHRE PRIVATSPHÄRE ]",
        noticeLabel: "Wichtiger Hinweis:",
        noticeBody: "Eindeutige Trennung: 1) Die mobile TrustNode-App läuft zu 100 % lokal auf Ihrem Gerät; alle KI-Schutzmechanismen werden auf der CPU Ihres Smartphones ausgeführt, ohne dass Datenverkehr oder Dateien an unsere Server gesendet werden. 2) Diese Website (Wartelistenformular) erfasst ausschließlich den von Ihnen angegebenen Kontakt (E-Mail oder Telegram), um Sie über den vorzeitigen Zugang zu informieren. Diese Daten werden auf dem Server gespeichert, und Sie können jederzeit die vollständige Löschung beantragen."
      },
      s3: {
      ...
      s4: {
        heading: "[ DATENÜBERTRAGUNG UND KONTAKT MIT DEM BETREIBER ]",
        body: "Wir haben auf klassische Abonnement-Datenbanken auf der Website verzichtet. Der Kontakt zum Betreiber für frühen Zugang erfolgt auf eigene Initiative des Nutzers ausschließlich über sichere Drittanbieter-Messenger und soziale Plattformen (Telegram, VKontakte, TikTok). Durch die Weitergabe von Kontaktdaten in einer Direktnachricht erklärt der Nutzer seine freiwillige Zustimmung zur Kommunikation über Lizenzen."
      },
      s5: {
    ...
    terms: {
      ...
      s2: {
        ...
        noticeBody: "Der rechtliche Status der TrustNode-Software im Hinblick auf geltende regulatorische Anforderungen wird derzeit geprueft. Detaillierte Informationen werden nach Ruecksprache mit einem qualifizierten Rechtsberater veroeffentlicht."
      },
      s3: {
  ...
  security: {
    ...
    complianceText: "Der rechtliche Status der TrustNode-Software im Hinblick auf geltende regulatorische Anforderungen wird derzeit geprueft.",
    features: [
      {
  ...
  kira: {
    ...
    subtitle: "Ein intelligenter, sprachfähiger Begleiter in Entwicklung — geplant, vollständig im lokalen RAM zu laufen",
    badge: "PROJEKTZEITPLAN: KIRA",
    features: [
      {
        title: "Lokaler Intent-Klassifikator — Roadmap",
        desc: "Roadmap: ein feingetuntes Add-On auf Basis von rubert-tiny2 wird 15-20 spezifische Sicherheits-Intents erkennen, bei nur ~200 KB zusätzlichem Speicherbedarf."
      },
      {
        title: "100% Offline-Ausführung — Roadmap",
        desc: "Roadmap: ohne externe LLM-API-Aufrufe sollen die Antwortvorlagen vollständig offline mit sehr niedriger Latenz funktionieren."
      },
      {
        title: "Fortschrittliche Trainingsdaten",
        desc: "Synthetische Dialoge von Betrugsszenarien werden bereits jetzt in Google Colab mit Llama 3.1 und Qwen2.5 generiert — dieser Teil der Arbeit läuft bereits."
      }
    ]
  },
  explore: {
  ...
  earlyAccessPage: {
    ...
    subtitle: "Wählen Sie eines unserer Vorbestellungspakete und werden Sie Teil der Sicherheitsgemeinschaft der nächsten Generation",
    badge: "FRÜHZEITIGER ZUGRIFF // VORBESTELLUNGSPAKETE",
    pkgPriorityTitle: "Priorisierter Zugriff",
    pkgPriorityDesc: "Zugriff auf TrustNode v1, v3, Kira — am frühesten von allen + vorrangige Teilnahme am geschlossenen Beta-Test zukünftiger Module.",
    pkgStandardTitle: "Standard-Zugriff",
    pkgStandardDesc: "Lizenz für TrustNode v1 und v3 nach dem offiziellen Release.",
    pkgBasicTitle: "Basis-Zugriff",
    pkgBasicDesc: "Zugriff auf den Basis-Schutz von TrustNode v1.",
    pricePriority: "599₽",
    priceStandard: "299₽",
    priceBasic: "Kostenlos",
    ...
    ticketReadyInstruction: "Kopieren Sie die Ticket-ID unten und fahren Sie mit der Zahlung fort, um die Registrierung abzuschließen.",
    btnGoToPayment: "Zur Zahlung übergehen",
    paymentDisclaimer: "Die Zahlung wird über ein sicheres externes Gateway abgewickelt. Ihre Daten sind geschützt.",
...
const ja: Translations = {
  ...
  how: {
    ...
    layers: [
      ...
      {
        name: "行動分析 — 特許出願ロードマップ",
        tech: "文脈認識ステートマシン・開発中",
        desc: "ロードマップ：入力速度、通話中の銀行アプリ切り替え頻度、異常な遅延、注意保持パターンなど、やり取りの動態を将来的に追跡する予定です。"
      },
      {
        name: "PHANTOMコンセンサス — 特許出願ロードマップ",
        tech: "合意形成投票エンジン・開発中",
        desc: "ロードマップ：すべての層の出力に基づき最終判断を下し、攻撃の疑いがある場合に画面をロックし信頼できる連絡先に通知する機能を将来実装予定です。"
      }
    ],
    usp: [
      {
    ...
    sevenLayers: [
      ...
      {
        name: "ソーシャルエンジニアリング (Social Eng. Layer) — 特許出願ロードマップ",
        tech: "DeGenome (18プリミティブ)・開発中",
        desc: "ロードマップ：18のプリミティブからなる DeGenome 分類法を用いて、人工的な緊急性・強迫言動・恐怖トリガー・孤立要請などの操作手口を特定する予定です。"
      },
      {
        name: "行動監査 (Behavioral Layer) — 特許出願ロードマップ",
        tech: "Context-Aware State Machine・開発中",
        desc: "ロードマップ：タイピングリズム、認知処理の遅延、アプリ切り替え頻度など、リアルタイムのユーザー操作を継続的に追跡する予定です。"
      },
      {
        name: "評判検証 (Reputation Layer) — 特許出願ロードマップ",
        tech: "PCD Identity Profiles・開発中",
        desc: "ロードマップ：発信者の特徴を企業アイデンティティプロファイル（PCD）と照合し、公式プロトコルとの不一致を特定する機能を実装予定です。"
      },
      {
        name: "合意形成 (Consensus Agent) — 特許出願ロードマップ",
        tech: "Consensus Voting Engine・開発中",
        desc: "ロードマップ：すべての階層からのリスクマーカーを集計する JudgeAgent エンジンが、脅威しきい値到達時に実行をロックし信頼できる連絡先に通知する予定です。"
      },
      {
        name: "免疫記憶 (Immune Memory) — 特許出願ロードマップ",
        tech: "Adaptive Incident Shield・開発中",
        desc: "ロードマップ：最近緩和された脅威に基づき、デバイス上でセキュリティフィルターを微調整する安全な攻撃リポジトリを実装予定です。"
      }
    ],
    btnSimplified: "簡易構造表示",
    btnAdvanced: "特許出願中 PHANTOM 2.0 アーキテクチャ（ロードマップ、7レイヤー）",
    pipelineHeader: "特許出願中 PHANTOM 2.0 アーキテクチャ — 開発ロードマップ"
  },
  trust: {
    badge: "科学的検証と評価",
    title: "科学的",
  ...
  legal: {
    ...
    privacy: {
      s1: {
        heading: "[ 総則 ]",
        body: "本プライバシーポリシーは、2006年7月27日付ロシア連邦法第152-FZ号「個人データについて」の要件に基づき作成されています。本ポリシーは、TrustNode Protocolプロジェクトチーム（以下「運営者」）によるユーザー個人データの取扱方法およびそのセキュリティ対策を定めるものです。"
      },
      s2: {
        heading: "[ ドームの原則：プライバシーを100%保護 ]",
        noticeLabel: "重要なお知らせ：",
        noticeBody: "情報の明確な区分：1) TrustNodeモバイルアプリは100%端末内でローカルに動作します。保護用AIアルゴリズムはすべてスマートフォンのプロセッサ上で実行され、通信データやファイルが弊社のサーバーに送信されることはありません。2) 本ウェブサイト（ウェイトリスト登録フォーム）は、早期アクセスのご案内を目的に、ご入力いただいた連絡先（メールアドレスまたはTelegram）のみを収集・保存します。これらのデータはサーバーに保管され、いつでも完全な削除をリクエストできます。"
      },
      s3: {
        heading: "[ サイトが処理するデータ ]",
      ...
      s4: {
        heading: "[ データの受け渡しと運営者への連絡 ]",
        body: "当サイトでは標準的な登録フォームによるサブスクリプションデータベースを廃止しています。早期アクセスに関する運営者への連絡は、ユーザー自身の意思により、Telegram、VKontakte、TikTokなどの第三者の安全なメッセージアプリやSNSを通じてのみ行われます。ダイレクトメッセージで連絡先情報を伝えることにより、ユーザーはライセンスに関するやり取りへの任意の同意を示したものとみなされます。"
      },
      s5: {
    ...
    terms: {
      ...
      s2: {
        ...
        noticeLabel: "重要な法的注記：",
        noticeBody: "TrustNodeソフトウェアの関連法規制上の法的地位については現在確認中です。詳細情報は専門の法律顧問への相談後に公開されます。"
      },
      s3: {
        heading: "[ 3. 知的財産権 ]",
      ...
      s4: {
        heading: "[ 4. ライセンス利用規則 ]",
        body: "有料の早期アクセスは、ソフトウェアのインストール時に電子的に署名または同意される個別のエンドユーザーライセンス契約（EULA）に基づいてのみ提供されます。TrustNodeソフトウェアを第三者の通信を不正に傍受する目的、またはロシアの電気通信ネットワークにおけるその他の違法行為に使用することは禁止されています。"
      },
      s5: {
        heading: "[ 5. 規約の変更 ]",
  ...
  origin: {
    ...
    timeline: [
      ...
      {
        badge: "モスクワ // 2026年9月",
        title: "全国スーパーファイナルへの招待",
        desc: "地域コンテストでの優勝を受け、専門学校の全額援助のもと、2026年9月にモスクワで開催される権威ある全国研究コンテスト・スーパーファイナルへの出場が決定しました。"
      },
      {
  ...
  security: {
    ...
    complianceText: "TrustNodeソフトウェアの関連法規制上の法的地位については現在確認中です。",
    features: [
      {
  ...
  kira: {
    title: "音声アシスタント KIRA",
    subtitle: "開発中のインテリジェントな音声認識回路 — スマートフォンの RAM 上で完全に動作する予定です",
    badge: "プロジェクト計画：KIRA",
    features: [
      {
        title: "ローカル意図分類器 — ロードマップ",
        desc: "ロードマップ：rubert-tiny2 をベースにした調整レイヤーが、約200 KBの追加のみで15〜20個のセキュリティ意図を識別する予定です。"
      },
      {
        title: "100% オフライン動作 — ロードマップ",
        desc: "ロードマップ：クラウド LLM への問い合わせなしで、応答テンプレートが超低遅延で完全オフライン動作する予定です。"
      },
      {
        title: "高度な合成データセット",
        desc: "詐欺スキームの合成対話データセットは、すでに Google Colab 上で Llama 3.1 や Qwen2.5 を用いて生成されています — この部分の作業は現在進行中です。"
      }
    ]
  },
  explore: {
  ...
  earlyAccessPage: {
    ...
    subtitle: "早期アクセスパッケージを選択して、次世代のセキュリティコミュニティに参加しましょう",
    badge: "早期アクセス // プレオーダーパッケージ",
    pkgPriorityTitle: "プライオリティ・アクセス",
    pkgPriorityDesc: "TrustNode v1、v3、Kiraへの最速アクセス + 将来のモジュールのクローズドβテストへの優先参加。",
    pkgStandardTitle: "スタンダード・アクセス",
    pkgStandardDesc: "正式リリース後のTrustNode v1およびv3のライセンス。",
    pkgBasicTitle: "ベーシック・アクセス",
    pkgBasicDesc: "TrustNode v1の基本保護機能へのアクセス。",
    pricePriority: "599₽",
    priceStandard: "299₽",
    priceBasic: "無料",
    ...
    ticketReadyInstruction: "登録を完了するには、以下のチケットIDをコピーして支払いにお進みください。",
    btnGoToPayment: "支払いへ進む",
    paymentDisclaimer: "支払いは安全な外部ゲートウェイを介して処理されます。データは保護されます。",
    selectedPackageLabel: "選択されたパッケージ"
  },
  comparisonPage: {
    title: "Honest Comparison",
    subtitle: "An objective comparative analysis of TrustNode vs leading global security solutions",
